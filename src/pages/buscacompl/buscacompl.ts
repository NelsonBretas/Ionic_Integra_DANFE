...
import { ComplPage } from '../compl/compl';

/**
 * Generated class for the BuscacomplPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-buscacompl',
  templateUrl: 'buscacompl.html',
})
export class BuscacomplPage 
{
